  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      <div className="text-center mb-8">
        ...
        <p className="text-white/70">Fique por dentro dos eventos que impactam o mercado</p>
      </div>
      ...
      <div className="space-y-6">
        {Object.entries(groupedEvents).map(([date, events]) => (
          <Card key={date} className="bg-white/10 backdrop-blur-sm border-white/20">
            <CardHeader>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-center">
                      ...
                      <div className="lg:col-span-2">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-white/80 text-sm">{event.country}</span>
                        </div>
                      </div>

                      {/* Event Details */}
                      <div className="lg:col-span-4">
                        <h3 className="text-white font-semibold mb-1">{event.event}</h3>
                      ...
                      <div className="lg:col-span-4">
                        <div className="grid grid-cols-3 gap-4 text-center">
                          <div>
                            <div className="text-xs text-white/60 mb-1">Anterior</div>
                            <div className="text-white font-medium">{event.previous}</div>
                          </div>
                          <div>
                            <div className="text-xs text-white/60 mb-1">Previsão</div>
                            <div className="text-blue-400 font-medium">{event.forecast}</div>
                          </div>
                          <div>
                            <div className="text-xs text-white/60 mb-1">Atual</div>
      ...
      <Card className="mt-8 bg-white/10 backdrop-blur-sm border-white/20">
        ...
        <CardContent>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h4 className="text-white font-semibold mb-3">Níveis de Impacto:</h4>
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  <Badge className="bg-red-500/20 text-red-300 border-red-500/30">⭐⭐⭐ ALTO</Badge>
                  <span className="text-white/70 text-sm">Pode causar alta volatilidade no mercado</span>
                </div>
                <div className="flex items-center gap-3">
                  <Badge className="bg-yellow-500/20 text-yellow-300 border-yellow-500/30">⭐⭐ MÉDIO</Badge>
                  <span className="text-white/70 text-sm">Impacto moderado nos preços</span>
                </div>
                <div className="flex items-center gap-3">
                  <Badge className="bg-green-500/20 text-green-300 border-green-500/30">⭐ BAIXO</Badge>
                  <span className="text-white/70 text-sm">Impacto limitado no mercado</span>
                </div>
              </div>
            </div>
            
            <div>
              <h4 className="text-white font-semibold mb-3">Interpretação dos Dados:</h4>
              <div className="space-y-2 text-sm text-white/70">
                <p><strong className="text-white">Anterior:</strong> Resultado do período anterior</p>
                <p><strong className="text-white">Previsão:</strong> Expectativa dos analistas</p>
                <p><strong className="text-white">Atual:</strong> Resultado real divulgado</p>
                <p className="text-green-400">Verde: Resultado acima da previsão</p>
                <p className="text-red-400">Vermelho: Resultado abaixo da previsão</p>
              </div>
            </div>
          </div>
        </CardContent>
