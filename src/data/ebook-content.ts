  ...
  chapters: [
    ...
    },
    {
        ...
        sections: [
          {
            ...
            image: "/images/diversification.png",
            description: "Não basta copiar vários traders. É preciso diversificar **estrategicamente**.",
            approach: [
              {
                name: "Diversificação por Perfil de Risco",
                allocation: "40% Conservador + 40% Moderado + 20% Agressivo",
                benefit: "Equilibra segurança com potencial de ganho"
              },
              {
                name: "Diversificação por Ativos",
                allocation: "Escolha traders que operam ativos diferentes",
                benefit: "Reduz risco de correlação (todos perderem juntos)"
              },
              {
                name: "Diversificação por Estratégia",
                allocation: "Combine swing traders (longo prazo) com day traders",
                benefit: "Aproveita diferentes condições de mercado"
              }
            ]
          },
          {
            ...
            rules: [
              {
                rule: "Regra dos 2%",
                description: "Nunca arrisque mais de 2% do seu capital total em uma única operação",
                example: "Com R$1.000, não arrisque mais de R$20 por trade"
              },
              {
                rule: "Regra do Drawdown Máximo",
                description: "Se seu drawdown total atingir 20%, pare e reavalie",
                action: "Pause todas as cópias e analise o que deu errado"
              },
              {
                rule: "Regra da Diversificação",
                description: "Nunca mais de 30% do capital em um único trader",
                benefit: "Se um trader falhar, você não perde tudo"
              },
              {
                rule: "Regra do Lucro Garantido",
                description: "A cada 20% de lucro, retire 10% para segurança",
                benefit: "Garante que você sempre sai com algo"
              }
            ]
          },
          {
            title: "Estratégia de Rebalanceamento",
            description: "Ajuste sua alocação mensalmente baseado em performance.",
            steps: [
              "No final de cada mês, analise performance de cada trader",
              "Traders com performance ruim (abaixo de 3%): reduza alocação ou pause",
              "Traders com performance boa (acima de 8%): mantenha ou aumente levemente",
              "Traders com performance excepcional (acima de 15%): cuidado! Pode ser sorte temporária",
              "Rebalanceie para manter proporção de risco desejada"
            ]
          },
          {
            ...
            techniques: [
              {
                name: "Trailing Stop",
                description: "Move o Stop Loss conforme o lucro aumenta",
                example: "Se você está com +10% de lucro, mova Stop Loss para +5%"
              },
              {
                name: "Escalonamento de Saída",
                description: "Retire lucros parcialmente em marcos específicos",
                example: "Retire 25% do lucro a cada 10% de ganho"
              },
              {
                name: "Reinvestimento Progressivo",
                description: "Reinvista apenas uma porcentagem dos lucros",
                example: "Lucrou R$100? Retire R$50 e reinvista R$50"
              }
            ]
          }
        ]
      ...
      checklist: [
        {
          id: "cap6-1",
          text: "Implementei diversificação por perfil de risco"
        },
        {
          id: "cap6-2",
        ...
        {
          id: "cap6-4",
          text: "Uso estratégia de proteção de lucros"
        }
      ]
    },
    {
      ...
      content: {
        intro: "É fundamental entender tanto as vantagens quanto os riscos do Copy Trading para tomar decisões informadas.",
        sections: [
          {
            title: "Vantagens",
            benefits: [
              {
                ...
                description: "Você não precisa ser especialista em análise técnica ou gráficos. Basta escolher bem o trader e deixar o sistema trabalhar.",
                impact: "Reduz drasticamente a curva de aprendizado"
              },
              {
                name: "Economia de Tempo",
                description: "Não precisa ficar horas analisando gráficos ou acompanhando notícias do mercado.",
                impact: "Ideal para quem tem outras atividades profissionais"
              },
              {
                name: "Aprendizado Prático",
                description: "Ao observar as operações dos traders, você aprende estratégias reais na prática.",
                impact: "Educação financeira enquanto investe"
              },
              {
                name: "Diversificação Facilitada",
                description: "Pode copiar múltiplos traders simultaneamente, diversificando automaticamente.",
                impact: "Redução de risco sem esforço extra"
              },
              {
                name: "Transparência",
                description: "Todo histórico dos traders é público e verificável.",
                impact: "Decisões baseadas em dados reais, não promessas"
              }
            ]
          },
          {
            ...
            risks: [
              {
                ...
                description: "Mesmo os melhores traders têm períodos de perda. Não existe garantia de lucro.",
                mitigation: "Diversifique e use Stop Loss para limitar perdas"
              },
              {
                name: "Risco de Drawdown",
                description: "Seu capital pode diminuir significativamente em períodos de perdas consecutivas.",
                mitigation: "Escolha traders com drawdown histórico baixo (máximo 25%)"
              },
              {
                name: "Dependência de Terceiros",
                description: "Você depende das decisões do trader. Se ele errar, você erra junto.",
                mitigation: "Monitore regularmente e tenha critérios para pausar a cópia"
              },
              {
                name: "Risco de Mudança de Estratégia",
                description: "O trader pode mudar sua estratégia sem aviso, aumentando o risco.",
                mitigation: "Acompanhe as operações e pause se notar mudanças drásticas"
              },
              {
                name: "Risco de Mercado",
                description: "Eventos inesperados (crises, notícias) podem causar perdas súbitas.",
                mitigation: "Use 'Checkout na sexta' e nunca invista dinheiro que precisa"
              },
              {
                name: "Excesso de Confiança",
                description: "Após alguns lucros, você pode se tornar confiante demais e aumentar riscos.",
                mitigation: "Mantenha disciplina e siga sempre as regras de gestão de risco"
              }
            ]
          },
          {
            ...
            statistics: [
              {
                fact: "95% dos traders perdem dinheiro",
                context: "A maioria das pessoas que tenta fazer trading sozinha perde capital",
                lesson: "Copy Trading aumenta suas chances ao copiar os 5% que são lucrativos"
              },
              {
                fact: "Tempo médio para consistência: 3-6 meses",
                context: "Leva tempo para encontrar os traders certos e ajustar estratégias",
                lesson: "Tenha paciência e não desista nos primeiros meses"
              },
              {
                fact: "Retorno realista: 5-15% ao mês",
                context: "Traders consistentes geralmente entregam entre 5-15% mensais",
                lesson: "Desconfie de promessas de 50%+ ao mês"
              }
            ]
          }
        ]
      ...
      checklist: [
        {
          id: "cap7-1",
          text: "Entendi as vantagens do Copy Trading"
        },
        {
          id: "cap7-2",
          text: "Compreendi todos os riscos envolvidos"
        },
        {
          id: "cap7-3",
          text: "Tenho expectativas realistas sobre retornos"
        },
        {
          id: "cap7-4",
          text: "Sei que nenhum trader acerta sempre"
        }
      ]
    },
    {
      ...
      icon: "CheckCircle",
      image: "/images/success-growth.png",
      content: {
        intro: "Parabéns por chegar até aqui! Você agora tem todo o conhecimento necessário para começar no Copy Trading com segurança.",
        sections: [
          {
            title: "Resumo do Aprendizado",
            summary: [
              "Copy Trading permite replicar operações de traders experientes com controle total do capital",
              "Conceitos essenciais: alavancagem, drawdown, Stop Loss, Take Profit e gestão de risco",
              "Estratégias diferenciadas: conservadora, moderada e agressiva, adaptadas ao seu perfil",
              "Ferramentas da Exness: Stop Loss automático, checkout na sexta, monitoramento em tempo real",
              "Diversificação é fundamental para reduzir riscos",
              "Disciplina e paciência são mais importantes que sorte"
            ]
          },
          {
            ...
            steps_detailed: [
              {
                step: "1. Crie sua conta na Exness",
                action: "Acesse o site oficial e complete o cadastro",
                time: "15 minutos"
              },
              {
                step: "2. Valide sua identidade",
                action: "Envie documentos e aguarde aprovação",
                time: "24-48 horas"
              },
              {
                step: "3. Faça seu primeiro depósito",
                action: "Comece com R$200-500 via PIX",
                time: "Instantâneo"
              },
              {
                step: "4. Explore o Marketplace",
                action: "Analise pelo menos 10 traders usando os critérios aprendidos",
                time: "1-2 horas"
              },
              {
                step: "5. Configure sua primeira cópia",
                action: "Escolha um trader conservador e invista 20-30% do capital",
                time: "10 minutos"
              },
              {
                step: "6. Use a planilha de acompanhamento",
                action: "Baixe a planilha fornecida e registre suas operações",
                time: "5 minutos semanais"
              },
              {
                step: "7. Monitore e ajuste",
                action: "Acompanhe semanalmente e faça rebalanceamento mensal",
                time: "Contínuo"
              }
            ]
          },
          {
            ...
            mindset: [
              {
                principle: "Paciência",
                description: "Copy Trading não é loteria. Resultados consistentes levam tempo (3-6 meses).",
                action: "Não desista após uma semana de perdas"
              },
              {
                principle: "Disciplina",
                description: "Siga sempre as regras de gestão de risco, mesmo quando tentado a arriscar mais.",
                action: "Crie um checklist e siga religiosamente"
              },
              {
                principle: "Aprendizado Contínuo",
                description: "O mercado muda. Continue aprendendo e ajustando estratégias.",
                action: "Dedique 30 minutos semanais para estudar"
              },
              {
                principle: "Realismo",
                description: "Tenha expectativas realistas. 5-15% ao mês é excelente.",
                action: "Desconfie de promessas milagrosas"
              },
              {
                principle: "Controle Emocional",
                description: "Não deixe emoções (ganância, medo) guiarem suas decisões.",
                action: "Tome decisões baseadas em dados, não em sentimentos"
              }
            ]
          },
          {
            ...
            resources: [
              "Planilha de Acompanhamento de Trades (disponível na Área VIP)",
              "Calculadora de Risco (disponível na Área VIP)",
              "Comunidade VIP para tirar dúvidas e trocar experiências",
              "Atualizações mensais com novos traders recomendados"
            ]
          },
          {
            title: "Mensagem Final",
            message: "O Copy Trading da Exness é uma ferramenta poderosa, mas como qualquer investimento, requer conhecimento, disciplina e paciência. Você agora tem o conhecimento. A disciplina e paciência dependem de você. Comece pequeno, aprenda com a experiência, e construa sua jornada de forma sustentável. Sucesso!"
          }
        ]
      },
      checklist: [
        {
          id: "cap8-1",
          text: "Revisei todos os conceitos essenciais"
        },
        {
          id: "cap8-2",
          text: "Tenho um plano de ação claro para começar"
        },
        {
          id: "cap8-3",
          text: "Entendi a importância da mentalidade correta"
        },
        {
          id: "cap8-4",
          text: "Estou pronto para começar com disciplina e paciência"
        }
      ]
    }
  ]
